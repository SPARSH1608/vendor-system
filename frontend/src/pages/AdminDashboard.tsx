...
const AdminDashboard = () => {
  ...
  if (!stats) {
    return <div className="text-gray-500 text-center py-8">{t("noDataAvailable")}</div>;
  }
  ...
  return (
    <div className="space-y-6 px-2 sm:px-4 md:px-8 max-w-6xl mx-auto">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{t("adminDashboard")}</h1>
        <p className="text-gray-600 mt-1 text-sm sm:text-base">{t("welcomeBack")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
          <div className="flex items-center mb-4 sm:mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">{t("recentActivities")}</h2>
          </div>
          <p className="text-gray-600 text-xs sm:text-sm mb-4 sm:mb-6">{t("latestSystemUpdates")}</p>
            ...
            {stats.recentActivities?.map((activity: any, index: number) => (
              <div key={index} className="flex items-start space-x-2 sm:space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">{t("byUser", { user: activity.user })}</p>
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
          <div className="flex items-center mb-4 sm:mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">{t("topPerformingVendors")}</h2>
          </div>
          <p className="text-gray-600 text-xs sm:text-sm mb-4 sm:mb-6">{t("highestRevenueVendors")}</p>
          <div className="space-y-3 sm:space-y-4">
            {stats.topVendors?.map((vendor: any, index: number) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-600">{t("transactions", { count: vendor.totalActivities })}</p>
                </div>
              </div>
            ))}
          </div>
