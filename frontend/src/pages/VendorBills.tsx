...
const VendorBills = () => {
  ...
  const statusOptions = ["All Status", "draft", "unpaid", "paid"]
    ...
    <div className="space-y-6 px-2 sm:px-4 md:px-8 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1 text-sm sm:text-base">Manage all your customer bills</p>
        </div>
        <button
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-xs sm:text-sm text-gray-600 space-y-1">
                      ...
                      <p>
                        Bill ID: {bill.billNumber} • Date: {formatDate(bill.createdAt)}
                      </p>
                      <p className="truncate">Items: {bill.items.map((item) => `${item.productName} (${item.quantity})`).join(", ")}</p>
                    </div>
                  </div>
                  <div className="flex flex-row sm:flex-col items-end sm:items-end space-x-4 sm:space-x-0 sm:space-y-2">
                    <div className="text-right">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600">{bill.items.length} item(s)</p>
                    </div>
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-4 sm:p-6 border-b border-gray-100">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900">Bill Details</h2>
                  <p className="text-xs sm:text-sm text-gray-600">
                    Bill ID: {selectedBill.billNumber} • Created on {formatDate(selectedBill.createdAt)}
                  </p>
                </div>
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg text-xs sm:text-sm">
                  ...
                  <p>
                    <strong>Email:</strong> {selectedBill.customer.email}
                  </p>
                  <p>
              ...
              {/* Status Change */}
              <div className="mb-6">
                <h3 className="font-semibold text-gray-900 mb-2">Change Bill Status</h3>
                <select
