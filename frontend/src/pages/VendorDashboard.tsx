...
import { Package, MapPin, TrendingUp, Calendar } from "lucide-react"
    ...
    <div>
      ...
      <div className="space-y-8 mt-16 px-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">Welcome back! Manage your daily activities and track your performance.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">No activities recorded for today</p>
