...
const locations = [
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">{t("dailyActivityTitle")}</h1>
        <p className="text-gray-600 mt-1">{t("dailyActivityDesc")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900">{t("selectLocationTitle")}</h2>
            </div>
            <p className="text-gray-600 text-sm mb-4">{t("selectLocationDesc")}</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-gray-600 text-sm mb-4">{t("selectedProductsDesc")}</p>

            {selectedProducts.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-gray-500">{t("noProductsSelected")}</p>
              </div>
            ) : (
                  ...
                  <div key={item.product_id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ₹{item.price} {t("perUnit", { unit: item.stock_unit })}
                      </p>
                    </div>
        ...
        <div className="space-y-6">
          {/* Add More Products */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-2">{t("addMoreProductsTitle")}</h2>
            <p className="text-gray-600 text-sm mb-4">{t("addMoreProductsDesc")}</p>
          ...
          {/* Summary */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-2">{t("summaryTitle")}</h2>
            <p className="text-gray-600 text-sm mb-4">{t("summaryDesc")}</p>

            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-gray-600">{t("location")}:</span>
                <span className="font-medium">{selectedLocation || t("notSelected")}</span>
              </div>
              <div className="flex justify-between">
